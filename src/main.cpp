...
uint32_t traverse_heap(HeapBlock *start) {
  ...
  while (true) {
    ...
    if (reinterpret_cast<std::uintptr_t>(ptr) % alignof(decltype(ptr))) {
    ...
    ptr = reinterpret_cast<HeapBlock *>(reinterpret_cast<std::uintptr_t>(ptr) +
...
int main() {
  ...
  std::printf("Heap size: %zu (%zu free)\n",
              reinterpret_cast<std::uintptr_t>(*heap_ptr) -
  ...
  {
    //auto free_list_head = reinterpret_cast<HeapBlock *>(reinterpret_cast<std::uintptr_t>(os::allocate_memory(0)) + HEADER_SIZE);
    ...
    auto donate = reinterpret_cast<void *>(reinterpret_cast<std::uintptr_t>(big) + 1024);
    ...
    os::donate_memory(2048, reinterpret_cast<void *>(reinterpret_cast<std::uintptr_t>(donate) + 2048));
